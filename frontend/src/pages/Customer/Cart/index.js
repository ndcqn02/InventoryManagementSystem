...
const Cart = () => {
   return (
      <div className="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
         ...
         <div className="mt-10 flex flex-col rounded xl:flex-row jusitfy-center items-stretch  w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0">
            <div className="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
               <div className="flex flex-col justify-start items-start bg-gray-100 rounded-lg px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full">
               ...
               <div className="flex justify-center md:flex-row flex-col items-stretch w-full space-y-4 md:space-y-0 md:space-x-6 xl:space-x-8">
                  <div className="flex flex-col rounded-lg px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 space-y-6   ">
                     ...
                     <div className="flex justify-center items-center w-full space-y-4 flex-col border-gray-200 border-b pb-4">
                        <div className="flex justify-between  w-full">
                           ...
                           <input type="text" className="p-2 text-base leading-4 text-gray-800" defaultValue="Nguyễn Đức Cường" />
                        </div>
                        <div className="flex justify-between items-center w-full">
                           <p className="text-base leading-4 text-gray-800">Địa chỉ</p>
                           <input type="text" className="p-2 text-base leading-4 text-gray-800" defaultValue="48 Cao Thắng - Đà Nẵng" />

                        </div>
                        <div className="flex justify-between items-center w-full">
                           <p className="text-base leading-4 text-gray-800">Số điện thoại</p>
                           <input type="text" className="p-2 text-base leading-4 text-gray-800" defaultValue="0987654321" />
                  ...
                  <div className="flex flex-col rounded-lg justify-center px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 space-y-6   ">
                     ...
                     <div className="w-full flex justify-center items-center">
                        <button className="rounded-lg hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-800 p-4 w-96 md:w-full bg-blue-800 text-base font-medium leading-4 text-white">
                           Đặt hàng
                        </button>
                     </div>
                  </div>
