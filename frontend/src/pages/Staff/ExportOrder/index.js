...
const TABLE_HEAD = ['Mã phiếu nhập', 'Nhân viên', 'Nhà cung cấp', 'Số lượng', 'Trạng thái', 'Ngày tạo', ''];
                     ...
                     {TABLE_ROWS.map(({ orderId, img, name, supplier, quantity, exported, date }, index) => {
                        ...
                        return (
                           <tr key={name}>
                              ...
                              <td className={classes}>
                                 <div className="w-max">
                                    <Chip
                                       variant="ghost"
                                       size="sm"
                                       value={exported ? 'Đã yêu cầu' : 'Chưa xuất hàng'}
                                       color={exported ? 'yellow' : 'blue-gray'}
                                    />
                                 </div>
                              </td>
                              <td className={classes}>
                              ...
                              <td className={classes}>
                                 <Tooltip content="Xem chi tiết phiêu xuất">
                                    <Link to="/staff/export-request">
